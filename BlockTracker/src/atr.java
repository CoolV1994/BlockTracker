...
private static final oa a = new oa("air");
   ...
   public boolean f(aqu var1, dt var2) {
      return false;
   }
   ...
   public float g(aqu var1, dt var2) {
      return this.w;
   }
   ...
   public void a(aqu var1, dt var2, bec var3, brt var4, List<brt> var5, wv var6) {
   ...
   public static void a(aqu var0, dt var1, amj var2) {
   ...
   protected void b(aqu var1, dt var2, int var3) {
      if(!var1.D) {
         while(var3 > 0) {
            int var4 = xk.a(var3);
            var3 -= var4;
            var1.d((wv)(new xk(var1, (double)var2.n() + 0.5D, (double)var2.o() + 0.5D, (double)var2.p() + 0.5D, var4)));
         }
      }
   ...
   public boolean a(aqu var1, dt var2, ej var3, amj var4) {
