public class qx {
	...
	public void a() {
		...
		if (this.h) {
			...
			if (var2.r() == bof.a) {
				...
				var3 = var2.a((ahd) this.b, this.b.o, this.i)
						* (float) (var1 + 1);
				var4 = (int) (var3 * 10.0F);
				if (var4 != this.k) {
			...
			if (var5.r() == bof.a) {
				...
				var3 = var5.a((ahd) this.b, this.b.o, this.i)
						* (float) (var6 + 1);
				var4 = (int) (var3 * 10.0F);
				if (var4 != this.k) {
	...
	public void a(dt var1) {
		if (var1.equals(this.f)) {
			...
			atr var3 = this.a.p(var1).c();
			if (var3.r() != bof.a) {
				float var4 = var3.a((ahd) this.b, this.b.o, var1)
						* (float) (var2 + 1);
				if (var4 >= 0.7F) {
					this.d = false;
	...
	public boolean a(ahd var1, aqu var2, amj var3) {
		if (this.c == arc.e) {
			...
			if (var6 == var3
					&& (var6 == null || var6.b == var4 && var6.l() <= 0
							&& var6.i() == var5)) {
				return false;
			} else {
	...
	public boolean a(ahd var1, aqu var2, amj var3, dt var4, ej var5,
		...
		if (this.c == arc.e) {
			...
			if (var3 == null) {
				...
				int var10 = var3.b;
				boolean var11 = var3
						.a(var1, var2, var4, var5, var6, var7, var8);
				var3.b(var12);
				var3.b = var10;
				return var11;
			} else {
